...
def test_alarm2_api():
    ...
    system_definition = os.path.join(
        os.getcwd(),
        r"tests\testutilities\legacy_files\TestAlarmAPI\TestAlarmAPI.nivssdf",
    )
    ...
    try:
        ...
        alarms = (
            "Alarm Group/AlarmTest1",
            "Alarm Group/AlarmTest2",
            "ConstantBoundAlarm",
        )
        ...
        assert (
            alarmTest1["ProcedureName"] == r"ResetAlarmTest1"
        ...
        BoundAlarmRef = NIVeriStand.Alarm(
            "ConstantBoundAlarm", "Controller", "localhost"
        )
