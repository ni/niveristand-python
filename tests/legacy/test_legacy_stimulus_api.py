...
def test_stimulus_api_legacy():
    ...
    system_definition = os.path.join(
        os.getcwd(),
        r"tests\testutilities\legacy_files\TestStimulusAPI\TestStimulusAPI.nivssdf",
    )
    ...
    try:
        ...
        logging_directory = os.path.join(
            os.getcwd(),
            r"tests\testutilities\legacy_files\TestStimulusAPI\TestStimulusAPI",
        )
        ...
        stimTest1.RunStimulusProfile(
            AutoStepTestStimulusAPI, logging_directory, 60000, 1, 1
        )
        time.sleep(1)
        result = stimTest1.GetStimulusProfileManagerState()
