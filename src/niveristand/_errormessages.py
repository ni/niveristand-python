...
invalid_nested_funcdef = (
    "Nested function definitions are only allowed inside a multitask."
)
...
param_description_no_param = (
    "The parameter specified in this definition does not exist."
)
invalid_function_definition = "Unsupported element in function definition."
invalid_param_decorator = (
    "Parameter description decorator doesn't follow parameter rules."
)
...
invalid_iterable_collection = (
    "The iterable collection can only be a variable or a range(end)."
)
...
invalid_stmt_after_try = (
    "Invalid statement after try block. Only return statements are allowed."
)
...
return_not_supported_in_try_finally = (
    "return statement not supported inside a try/finally block."
)
...
ref_param_not_ref = (
    "A parameter marked as pass by reference was not of valid object type."
)
invalid_error_code_for_generate_error = (
    "Invalid error code provided. Provide an integer number as an error code."
)
invalid_message_for_generate_error = (
    "Invalid error message provided. Provide a string message."
)
...
cascaded_comparison_operators_not_allowed = (
    "You cannot use cascading comparison operators. "
