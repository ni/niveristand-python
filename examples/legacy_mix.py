...
def mix_legacy_and_rtseq_run():
    """Combine the legacy API with python real-time sequences to run a deterministic test."""
    # Ensure NI VeriStand is running
    NIVeriStand.LaunchNIVeriStand()
    # Use the ClientAPI interface to get a reference to Workspace2
